...
Altri errori di traduzione (_other type of errors_) (1/0) [Noise tracking]: Flags the presence of general translation errors unrelated to gender, ensuring the analysis effectively isolates the MT systems' performance on the target phenomenon.
